        ...
        <div className={cn("relative flex w-full", className)}>
            <nav
                ...
                className={cn(
                    ...
                    "relative h-11 rounded-full transition-all duration-300 overflow-hidden w-full"
                )}
            >
                {/* Content */}
                {children ? (
                    <div className="relative flex items-center h-full px-3 sm:px-4 gap-2 sm:gap-4 z-[10] w-full justify-between">
                        {children}
                    </div>
                ) : (
