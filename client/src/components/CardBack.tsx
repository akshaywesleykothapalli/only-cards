...
export function CardBack({ count, className = '' }: CardBackProps) {
  ...
  return (
    ...
    >
      ...
      {/* Red glow effect */}
      <div className="absolute inset-0 rounded-[inherit] shadow-[0_0_20px_rgba(239,68,68,0.15)]" />
      
      {/* CARDS text */}
      <span className="card-back-label font-sans font-black italic text-white transform -skew-x-12 select-none relative z-10">
        CARDS
      </span>
